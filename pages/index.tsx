...
const navigation = [
  ...
  { name: "Groups", href: "/groups", icon: CalendarIcon, current: false },
  { name: "Projects", href: "/projects", icon: FolderIcon, current: false },
  { name: "Tasks", href: "/tasks", icon: ChartPieIcon, current: false },
];
      ...
      <div>
        ...
        <div
          className={`sticky top-0 z-40 flex items-center gap-x-6 bg-white px-4 py-4 shadow-sm sm:px-6 ${
            info?.role === "user" ? "" : "lg:hidden"
          }`}
        >
          <button
            type="button"
            className={`-m-2.5 p-2.5 text-gray-700 ${
              info?.role === "user" ? "hidden" : "lg:hidden"
            }`}
        ...
        <main className={`py-10 ${info?.role === "user" ? "" : "lg:pl-64"}`}>
          {info?.role === "admin" ? (
            <AdminDashboard />
          ) : info?.role === "user" ? (
            <UserDashboard />
